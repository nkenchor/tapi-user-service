...
class Event:
    def __init__(
        ...
        )  # Consider using datetime object for internal representation
    ...
    def deserialize(data: str):
        ...
        return Event(
            ...
            event_data=obj[
                "event_data"
            ],  # Further parsing may be required based on expected structure
        )
