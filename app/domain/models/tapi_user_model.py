...
class User:
    ...
    def serialize(self):
        ...
        # Custom handling for complex attributes like 'address' and 'companies'
        ...
        if hasattr(self, 'companies'):
            data['companies'] = [company.serialize() for company in self.companies if callable(getattr(company, 'serialize', None))]
