...
from app.infrastructure.messaging.redis.utils.helper.publish_helper import PublisherHelper


class RedisEventPublisher(IUserEventPublisher):
    def __init__(self, redis: Redis):
        self.redis_client = redis  # Assuming Redis.connect() returns a Redis client instance
